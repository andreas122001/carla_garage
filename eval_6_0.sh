...
export TM_PORT=`comm -23 <(seq 34900 35300 | sort) <(ss -Htan | awk '{print $4}' | cut -d':' -f2 | sort -u) | shuf | head -n 1`
echo 'TM Port:' $TM_PORT
export ROUTES=/cluster/work/andrebw/carla_garage/data/50x36_town_13/BlockedIntersection/6_0.xml
